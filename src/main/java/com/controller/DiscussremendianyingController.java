...
public class DiscussremendianyingController {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,DiscussremendianyingEntity discussremendianying, HttpServletRequest request){
	...
	@IgnoreAuth
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,DiscussremendianyingEntity discussremendianying, HttpServletRequest request){
        EntityWrapper<DiscussremendianyingEntity> ew = new EntityWrapper<DiscussremendianyingEntity>();
    	PageUtils page = discussremendianyingService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, discussremendianying), params), params));
		request.setAttribute("data", page);
        return R.ok().put("data", page);
	...
	public R remindCount(@PathVariable("columnName") String columnName, HttpServletRequest request, 
		...
		Wrapper<DiscussremendianyingEntity> wrapper = new EntityWrapper<DiscussremendianyingEntity>();
		if(map.get("remindstart")!=null) {
		...
		int count = discussremendianyingService.selectCount(wrapper);
