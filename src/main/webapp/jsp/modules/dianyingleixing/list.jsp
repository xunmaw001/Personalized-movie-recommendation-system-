...
<body>
						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<div class="table-responsive mb-3">
								<div class="col-sm-12">
																																									<label>
												电影类型
												<input type="text" id="dianyingleixingSearch" class="form-control form-control-sm" placeholder="" aria-controls="tableId">
											</label>
	...
	<script>
		...
		function search(){
			searchForm = { key: ""};
													if($('#dianyingleixingSearch').val() != null && $('#dianyingleixingSearch').val() != ''){
					searchForm.dianyingleixing ="%" +  $('#dianyingleixingSearch').val() + "%";
				}
