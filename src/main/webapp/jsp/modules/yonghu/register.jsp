                        ...
                        <div class="form d-flex align-items-center">
                            <div class="content">
                                <form id="registerForm" action="" method="post" class="form-validate">
									<input type="text" placeholder="请输入用户账号" name="yonghuzhanghao" class="input-material">
									<input type="text" placeholder="请输入用户姓名" name="yonghuxingming" class="input-material">
									<input type="password" placeholder="请输入密码" name="mima" class="input-material">
									<input type="text" placeholder="请输入年龄" name="nianling" class="input-material">
									<input type="text" placeholder="请输入联系电话" name="lianxidianhua" class="input-material">
									<input type="text" placeholder="请输入电子邮箱" name="dianziyouxiang" class="input-material">
