...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">编辑热门电影</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item">热门电影管理</li>
								<li class="breadcrumb-item active">编辑热门电影</li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">热门电影信息</h3>
							<form id="addOrUpdateForm">
								<div class="form-row">
									<input id="updateId" name="id" type="hidden">
										<div class="form-group col-md-6">
										<label>电影编号</label>
										<input id="dianyingbianhao" name="dianyingbianhao" class="form-control" value="" readonly>
									</div>
											<div class="form-group col-md-6">
										<label>电影名称</label>
										...
										<input id="daoyan" name="daoyan" class="form-control" placeholder="导演">
																							...
																							<label>电影详情</label>
																							<input id="dianyingxiangqingupload" name="file" type="file">
												<script id="dianyingxiangqingEditor" type="text/plain" style="width:800px;height:230px;"></script>
												<script type="text/javascript">
												    //建议使用工厂方法getEditor创建和引用编辑器实例，如果在某个闭包下引用该编辑器，直接调用UE.getEditor('editor')就能拿到相关的实例
												   //相见文档配置属于你自己的编译器
												 var dianyingxiangqingUe = UE.getEditor('dianyingxiangqingEditor', {
													toolbars: [
														[
															'undo', //撤销
															'bold', //加粗
												...
												<input type="hidden" name="dianyingxiangqing" id="dianyingxiangqing-input">
											</div>	
	...
	<script type="text/javascript" charset="utf-8" src="${pageContext.request.contextPath}/resources/js/datetimepicker/bootstrap-datetimepicker.min.js"></script>
		...
		var crossRuleForm = {};
								...
								function dianyingbianhaoUuid(){
				if($("#dianyingbianhao").val() == null || $("#dianyingbianhao").val() == "null" || $("#dianyingbianhao").val() == ""){
					$("#dianyingbianhao").attr("value",Math.round(new Date().getTime()/1000));
				}
			}				
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "remendianying/info/" + id,
		...
		function upload(){
						...
						dataType: 'json',
							...
							$("#haibaoImg").attr("src",baseUrl+"upload/"+data.result.file);								
																																					...
																																					$('#dianyingxiangqingupload').fileupload({
						url: baseUrl + 'file/upload',
						headers:{ token: window.sessionStorage.getItem("token")},
						dataType: 'json',
						done: function (e, data) {	
							UE.getEditor('dianyingxiangqingEditor').execCommand('insertHtml','<img src=\"'+ baseUrl +'upload/'+ data.result.file + '\" width=900 height=560>');					
						}
					});
																							}  
		...
		function submit() {
			if(validform() ==true && compare() == true){
				...
				httpJson("remendianying/"+urlParam,"POST",data,(res)=>{
					if(res.code == 0){
		...
		// 填充富文本框
		function setContent(){
																																																										if(ruleForm.dianyingxiangqing != null && ruleForm.dianyingxiangqing != 'null' && ruleForm.dianyingxiangqing != ''){
					var dianyingxiangqingMes = '' + ruleForm.dianyingxiangqing;
					var dianyingxiangqingUeditor = UE.getEditor('dianyingxiangqingEditor');
					dianyingxiangqingUeditor.ready(function() {
						dianyingxiangqingUeditor.setContent(dianyingxiangqingMes);
					});
				}
																				}  
		...
		// 获取富文本框内容
		function getContent(){
																																																										if(UE.getEditor('dianyingxiangqingEditor').hasContents()){
					$('#dianyingxiangqing-input').attr('value',UE.getEditor('dianyingxiangqingEditor').getPlainTxt());
				}
																				}
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("remendianying/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						// 是/否下拉框回显
						setSelectOption();
		...
		function calculationSE(colName){
			//单列求和接口
			http("remendianying"+colName,"GET",{
		...
		function dataBind(){
			$("#updateId").val(ruleForm.id);	
												$("#dianyingbianhao").val(ruleForm.dianyingbianhao);	
					...
					$("#shipinFileName").html(ruleForm.shipin);
																...
																$("#dianyingxiangqing").val(ruleForm.dianyingxiangqing);	
				...
				http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
					if(res.code == 0){
						...
						$('#updateId').val(crossTableId);
												if(res.data != null && res.data != '' && res.data.dianyingbianhao != null && res.data.dianyingbianhao != ''){

															$("#dianyingbianhao").val(res.data.dianyingbianhao);
													}
								...
								$("#haibao-input").val(res.data.haibao);
												...
												if(res.data != null && res.data != '' && res.data.dianyingxiangqing != null && res.data.dianyingxiangqing != ''){

															$("#dianyingxiangqing").val(res.data.dianyingxiangqing);
													}
