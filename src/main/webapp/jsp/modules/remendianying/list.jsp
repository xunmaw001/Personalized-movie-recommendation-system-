		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">热门电影管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active">热门电影列表</li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">热门电影列表</h3>							
											...
											<th class="no-sort" style="min-width: 35px;">
												<div class="custom-control custom-checkbox">
													...
													<label class="custom-control-label" for="select-all"></label>
																																						...
																																						<th onclick="sort('dianyingbianhao')">电影编号<i id="dianyingbianhaoIcon" class="fa fa-sort"></i></th>
																													...
																													<th>海报</th>
																																																			...
																																																			<th onclick="sort('dianyingxiangqing')">电影详情<i id="dianyingxiangqingIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function setDataRow(item,number){
			...
			row.appendChild(checkbox)
							...
							var dianyingbianhaoCell  = document.createElement('td');

												 dianyingbianhaoCell.innerHTML = item.dianyingbianhao;

				
									row.appendChild(dianyingbianhaoCell);
				  ...
				  haibaoCell.appendChild(haibaoImg);
									...
									row.appendChild(daoyanCell);
				            				var dianyingxiangqingCell  = document.createElement('td');

												  //如果图文详情包含图片
				  if(item.dianyingxiangqing && item.dianyingxiangqing.indexOf('img') != -1){
					//暂时只考虑图片+文字 和 文字+图片的情况
					var beginIndex = item.dianyingxiangqing.indexOf('<img');
					var endIndex = item.dianyingxiangqing.indexOf('>');				
					dianyingxiangqingCell.innerHTML = item.dianyingxiangqing.substring(beginIndex, endIndex+1).replace("img","img width='100' height='100'");				
				  }else{
				  	 if(item.dianyingxiangqing != null && item.dianyingxiangqing != "" && item.dianyingxiangqing.length >= 11){
				  		dianyingxiangqingCell.innerHTML = item.dianyingxiangqing.substring(0, 10) + "..."; 
				  	}else{
				  		dianyingxiangqingCell.innerHTML = item.dianyingxiangqing;
				 	}
				  }
				  

                
									row.appendChild(dianyingxiangqingCell);
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("remendianying/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
		...
		function crossTable(id,crossTableName){
			...
			window.sessionStorage.setItem('crossTableName',"remendianying");
