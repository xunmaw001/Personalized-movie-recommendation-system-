      ...
      <div class="form-inner">
          ...
          <div class="input-group">
            ...
            <div class="layui-form-item">
              <div class="layui-input-block" style="margin-left: 57px;">
                <input type="text" id="dianyingmingcheng" name="dianyingmingcheng" placeholder="请输入电影名称" autocomplete="off" class="layui-input" lay-ignore>
              </div>
            </div>
          </div>
        </div>
        <div class="input-wrapper">
          <div class="input-group">
            ...
            <div class="layui-form-item">
              <div class="layui-input-block" style="margin-left: 57px;">
                <input type="text" id="shizhang" name="shizhang" placeholder="请输入时长" autocomplete="off" class="layui-input" lay-ignore>
              </div>
            </div>
          </div>
        </div>
        <div class="input-wrapper">
          <div class="input-group">
            ...
            <div class="layui-form-item">
              <div class="layui-input-block" style="margin-left: 57px;">
                <input type="text" id="zhuyan" name="zhuyan" placeholder="请输入主演" autocomplete="off" class="layui-input" lay-ignore>
              </div>
            </div>
          </div>
        </div>
        <div class="input-wrapper">
          <div class="input-group">
            ...
            <div class="layui-form-item">
              <div class="layui-input-block" style="margin-left: 57px;">
                <input type="text" id="daoyan" name="daoyan" placeholder="请输入导演" autocomplete="off" class="layui-input" lay-ignore>
              </div>
            </div>
          </div>
        </div>
