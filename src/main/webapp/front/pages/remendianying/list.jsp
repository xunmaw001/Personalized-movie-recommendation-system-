        ...
        <fieldset class="search-container" style="text-align: center;margin: 30px 0;">
          <form class="layui-form">
            ...
            <div class="layui-inline" style="margin-bottom: 10px;">
              ...
              <div class="layui-input-inline">
                <input type="text" name="dianyingleixing" id="dianyingleixing" placeholder="电影类型" autocomplete="off" class="layui-input">
              </div>
            </div>   
            <div class="layui-inline" style="margin-left: 30px;margin-bottom: 10px;">
              ...
              <button v-if="isAuth('remendianying','新增')" @click="jump('../remendianying/add.jsp')" type="button" class="layui-btn btn-theme">
        ...
        <div class="pro-lists-con">
          <ul class="after">
            <li v-for="(item,index) in dataList" v-bind:key="index">
              <a target="_self" :href="'../remendianying/detail.jsp?id='+item.id">
                <div class="posi-img">
                  <img :src="item.haibao?item.haibao.split(',')[0]:''" width="385px" height="220px" />
                </div>
                <div class="remark">
                  <h5>{{item.dianyingmingcheng}}</h5>
  ...
  <script>
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage', 'http', 'jquery'], function() {
      ...
      function pageList() {
        ...
        if (jquery('#dianyingleixing').val()) {
          param['dianyingleixing'] = jquery('#dianyingleixing').val() ? '%' + jquery('#dianyingleixing').val() + '%' : '';
        }  
        // 获取列表数据
        http.request('remendianying/list', 'get', param, function(res) {
