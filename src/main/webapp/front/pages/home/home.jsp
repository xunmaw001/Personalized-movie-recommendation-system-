...
<body>
    ...
    <div class="plate">
      <div class="plate-pic picture-a after tb80 back-white" style='background:#fff;'>
        <div class="container">
          ...
          <div class="picture-lists">
            <ul class="wul105">
              <li v-for="(item,index) in remendianyingRecommend" v-bind:key="index">
                <a target="_self" :href="'../remendianying/detail.jsp?id='+item.id">
                  <div class="posi-img">
                    <img :src="item.haibao?item.haibao.split(',')[0]:''" width="385" height="220" />
                  </div>
                  <div class="remark">
      ...
      <div class="plate-pic picture-a after tb80 back-white" style='background:#fff;'>
        <div class="container">
          ...
          <div class="picture-lists">
            <ul class="wul105">
              <li v-for="(item,index) in remendianyingList" v-bind:key="index">
                <a target="_self" :href="'../remendianying/detail.jsp?id='+item.id">
                  <div class="posi-img">
                    <img :src="item.haibao?item.haibao.split(',')[0]:''" width="385" height="220" />
                  </div>
  ...
  <script>
    ...
    layui.use(['layer', 'form', 'element', 'carousel', 'http', 'jquery'], function() {
      ...
      http.request(`remendianying/autoSort`, 'get', {
        page: 1,
        limit: 6
      }, function(res) {
        vue.remendianyingRecommend = res.data.list;
      });

      http.request(`remendianying/list`, 'get', {
        page: 1,
        limit: 6
      }, function(res) {
        vue.remendianyingList = res.data.list;
      });
    });
  </script>
</body>
